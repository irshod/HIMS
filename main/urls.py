...
urlpatterns = [
    ...
    path('user_view/<int:user_id>/', views.view_user, name='view_user'),  # View User URL
    ...
    path('role_delete/<int:role_id>/', views.delete_role, name='delete_role'),
    path('role_view/<int:role_id>/', views.view_role, name='view_role'),  # View Role URL
